...
public class ClickRightStepTest extends AbstractClickButtonStepTestCase {
    ...
    public void test_selectMenuTableBadMenuItem()
        ...
        try {
            ...
            assertEquals("MenuItem non trouv� : menu99", e.getMessage());
        }
    }
    ...
    public void test_selectMenuTableNoPopupMenu()
        ...
        try {
            ...
            assertEquals("Le menu contextuel associ� au composant 'kingTable' est introuvable",
                         e.getMessage());
        }
    }
    ...
    public void test_selectMenuTreeBadItemMenu() throws Exception {
        try {
            ...
            assertEquals("Le menu contextuel associ� au composant 'treeName' est introuvable",
                         e.getMessage());
        }
    }
    ...
    public void test_selectMenuListBadMenuItem() throws Exception {
        ...
        try {
            ...
            assertEquals("MenuItem non trouv� : that is wrong dude!", e.getMessage());
        }
    }
    ...
    public void test_selectMenuListNoPopupMenu() throws Exception {
        ...
        try {
            ...
            assertEquals("Le menu contextuel associ� au composant 'kingList' est introuvable",
                         e.getMessage());
        }
    }
