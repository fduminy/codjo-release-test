...
import static net.codjo.test.release.task.gui.toolkit.swing.AbstractGuiStep.runAwtCode;
import static net.codjo.test.release.task.gui.toolkit.swing.AbstractGuiStep.runAwtCodeLater;
...
public class AssertValueStepTest extends JFCTestCase {
    ...
    public void test_ok() throws Exception {
        ...
        // JTextArea
        final String value = "premi�re ligne\ndeuxi�me ligne";
    ...
    private void addJHtmlEditorPane(final Container panel) {
        try {
            runAwtCode(new TestContext(this), new Runnable() {
                public void run() {
