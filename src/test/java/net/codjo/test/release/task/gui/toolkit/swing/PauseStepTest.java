...
public class PauseStepTest extends JFCTestCase {
    ...
    public void test_pause() throws Exception {
        ...
        assertFalse("Le proceed bloque donc le thread est bloqu�", proceedThread.proceedIsEnded);
        ...
        assertTrue("Le proceed � lach� la main donc le thread est termin�", proceedThread.proceedIsEnded);
    }
