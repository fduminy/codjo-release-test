...
public class AssertSelectedStepTest extends JFCTestCase {
    ...
    public void test_ok_table_cell() throws Exception {
        ...
        // S�lection de la cellule de coordonn�es (1,2)
    ...
    public void test_ko_bad_selection_path_tree() throws Exception {
        ...
        try {
            ...
            assertEquals(
                  "Le noeud s�lectionn� ne correspond pas : attendu = '[rootName, child1]' obtenu = '[rootName, child1, child11]'",
                  ex.getMessage());
        }
    }
    ...
    public void test_ko_no_selection_expected_tree() throws Exception {
        ...
        try {
            ...
            assertEquals("Aucune s�lection dans l'arbre est attendue.", ex.getMessage());
        }
    }
    ...
    public void test_ko_at_least_one_selection_expected_tree() throws Exception {
        ...
        try {
            ...
            assertEquals("Au moins une s�lection dans l'arbre est attendue.", ex.getMessage());
        }
    }
    ...
    public void test_ko_no_selection() throws Exception {
        ...
        try {
            ...
            assertEquals("Aucun noeud de l'arbre n'est s�lectionn�.", ex.getMessage());
        }
    }
    ...
    public void test_ko_no_specific_selection_expected_tree() throws Exception {
        ...
        try {
            ...
            assertEquals(
                  "Noeud '[rootName, child1, child11]' : attendu = 'non s�lectionn�' obtenu = 's�lectionn�'",
                  ex.getMessage());
        }
    }
