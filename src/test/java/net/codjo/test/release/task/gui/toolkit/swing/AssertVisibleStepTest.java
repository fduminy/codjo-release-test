...
import net.codjo.test.release.task.gui.AssertVisibleStep;
import net.codjo.test.release.task.gui.GuiConfigurationException;

import junit.extensions.jfcunit.JFCTestCase;
import junit.extensions.jfcunit.TestHelper;
import static net.codjo.test.release.task.gui.toolkit.swing.AssertVisibleStep.computeVisibleComponentMessage;
import static net.codjo.test.release.task.gui.toolkit.swing.AssertVisibleStep.computeNotVisibleComponentMessage;
...
public class AssertVisibleStepTest extends JFCTestCase {
    ...
    public void test_knownComponentVisibility() throws Exception {
        ...
        try {
            ...
            assertEquals(computeVisibleComponentMessage("combo"), e.getMessage());
        }
        ...
        try {
            ...
            assertEquals(computeNotVisibleComponentMessage("combo"), e.getMessage());
        }
    }
    ...
    public void test_knownComponentFailure() throws Exception {
        ...
        try {
            ...
            assertEquals(computeVisibleComponentMessage("LabelTest"), e.getMessage());
        }
    }
    ...
    public void test_unknownComponentFailure() throws Exception {
        ...
        try {
            ...
            assertEquals(computeNotVisibleComponentMessage("unknownComponent"),
                         e.getMessage());
        }
    }
    ...
    public void test_glassPaneComponent() throws Exception {
        JLabel label = new JLabel("je suis l�");
