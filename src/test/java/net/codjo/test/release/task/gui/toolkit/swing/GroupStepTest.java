...
import net.codjo.test.release.task.gui.AssertEditableStep;
import net.codjo.test.release.task.gui.AssertEnabledStep;
import net.codjo.test.release.task.gui.AssertFrameStep;
import net.codjo.test.release.task.gui.AssertListSizeStep;
import net.codjo.test.release.task.gui.AssertListStep;
import net.codjo.test.release.task.gui.AssertProgressDisplayStep;
import net.codjo.test.release.task.gui.AssertSelectedStep;
...
import net.codjo.test.release.task.gui.AssertTreeStep;
import net.codjo.test.release.task.gui.AssertValueStep;
import net.codjo.test.release.task.gui.ClickStep;
import net.codjo.test.release.task.gui.CloseFrameStep;
import net.codjo.test.release.task.gui.GroupStep;
import net.codjo.test.release.task.gui.GuiException;
import net.codjo.test.release.task.gui.GuiStep;
import net.codjo.test.release.task.gui.PauseStep;
import net.codjo.test.release.task.gui.SelectStep;
import net.codjo.test.release.task.gui.SelectTabStep;
...
public class GroupStepTest extends TestCase {
    ...
    public void testAddAssertProgressDisplayFailed() {
        try {
            ...
            assertEquals("La balise 'assertProgressDisplay' ne doit pas �tre la premi�re d'un groupe",
                         e.getMessage());
        }
    }
    ...
    public void testAddAssertProgressDisplaySuccess() {
        ...
        assertEquals(SwingGUIToolkit.ProgressDisplayPreparationStep.class, steps.get(1).getClass());
