...
//        step.setWaitingNumber(10);
    ...
    public void test_tableUnsupportedMultipleWithColumn()
        ...
        try {
            step.proceed(new TestContext(this));
            fail("Doit �chouer car multiple et column sont renseign�s.");
        }
    ...
    public void test_treeWithRenderer() throws Exception {
        ...
        try {
            step.proceed(new TestContext(this));
            fail("Doit �chouer car le noeud n'existe pas.");
        }
    ...
    public void test_treeUnsupportedRow() throws Exception {
        ...
        try {
            step.proceed(new TestContext(this));
            fail("Doit �chouer car row est renseign�.");
        }
    ...
    public void test_treePathNok() throws Exception {
        ...
        try {
            step.proceed(new TestContext(this));
            fail("Le noeud ne devrait pas �tre trouv�.");
        }
    ...
    public void test_nokNotFound() throws Exception {
        ...
        try {
            step.proceed(context);
            fail("Le composant ne devrait pas �tre trouv�.");
        }
    ...
    public void test_nokUnknownComponent() throws Exception {
        ...
        try {
            step.proceed(context);
            fail("Type de composant non support�.");
        }
        catch (GuiConfigurationException ex) {
            ; // Cas normal
        }
    ...
    public void test_findSubMenusInPopupMenus() throws Exception {
        ...
        step.setName("Popup");
        step.setLabel("frederic");
        net.codjo.test.release.task.gui.toolkit.swing.SelectStep<SelectStep> s = (net.codjo.test.release.task.gui.toolkit.swing.SelectStep<SelectStep>) SwingGuiTestUtils.createGuiStep(step);
        assertEquals(1, s.findComponentToSelect(popup, step));
    }
    ...
    public void test_jTableSelectCellByLabelDuplicate() throws Exception {
        ...
        try {
            ...
            assertEquals("Le label 'line2' est pr�sent plusieurs fois dans la table PortfolioList",
                         e.getMessage());
        }
    ...
    private void checkDisabledComponentSelection(Functor functor, String componentName) {
        ...
        try {
            ...
            assertEquals("Le composant '" + componentName + "' n'est pas �ditable.", ex.getMessage());
        }
    }
