...
import net.codjo.test.release.task.gui.toolkit.swing.FrenchKeyMapping;
/**
...
public class SetValueStepTest extends JFCTestCase {
    ...
    public void test_infoClassLegacy() throws Exception {
        ...
        // h�ritage et classInfo red�finie
    ...
    public void test_modeKeyboard() throws Exception {
        String value = "C�e� �t�e�s�t� �n�e� �m�a�r�c�h�e� �p�a�s� �!����ٟ� "
    ...
    private void checkDisabledComponent(JComponent component, String value) {
        ...
        try {
            ...
            assertEquals("Le composant '" + component.getName() + "' n'est pas �ditable.", e.getMessage());
        }
    }
    ...
    public void test_element_not_in_combo() throws Exception {
        ...
        try {
            ...
            assertEquals("L'�l�ment '" + step.getValue() + "' n'existe pas dans le composant "
    ...
    public void test_ok_listener() throws Exception {
        ...
        assertTrue("KeyListener a �t� appel�", nbKeyListenerCalled > 0);
    }
    ...
    private void addTextField2(JPanel panel) {
        ...
        textField2.setName("ChampCalcul�");
