...
public abstract class AbstractClickStepTest extends JFCTestCase {
    ...
    protected static final String BUTTON_LABEL = "D�tails";
    ...
    public void test_nok_noFrame() throws Exception {
        ...
        try {
            step.proceed(new TestContext(this));
            fail("Le clic n'a pas �chou� bien qu'il n'y ait pas de frame.");
        }
    ...
    public void test_nok_timeout() throws Exception {
        ...
        try {
            ...
            assertTrue("Timeout inf�rieur au timeout attendu (" + elaps + " contre " + step.getTimeout()
    ...
    public void test_nok_badMenu() throws Exception {
        ...
        try {
            ...
            step.proceed(new TestContext(this));
            fail("Le clic doit �chouer si la syntaxe de l'�l�ment de menu n'est pas bonne.");
        }
    ...
    public void test_nok_noMenuBar() throws Exception {
        ...
        try {
            step.setMenu("Fichier:Ouvrir");
            step.proceed(new TestContext(this));
            fail("Le clic doit �chouer si la frame n'a pas de menu");
        }
        catch (GuiFindException ex) {
            ; // OK
        }
    ...
    public void test_clickOnDisabledMenu() throws Exception {
        ...
        try {
            ...
            step.setMenu("Fichier:Ouvrir");
            step.proceed(new TestContext(this));
            fail("On ne doit pas pouvoir cliquer sur un menu gris�!");
        }
        catch (GuiFindException e) {
            assertEquals("Menu d�sactiv� : Fichier", e.getLocalizedMessage());
        }
    }
    ...
    public void test_clickOnDisabledMenuItem() throws Exception {
        ...
        try {
            ...
            assertEquals("Menu d�sactiv� : Ouvrir", e.getLocalizedMessage());
        }
    }
    ...
    public void test_clickToDisplayAPopupMenuWithUnkownEntry() throws Exception {
        ...
        try {
            ...
            assertEquals("MenuItem non trouv� : sous-menu inconnu", e.getMessage());
        }
    }
    ...
    public void test_clickToDisplayAPopupMenuWithDisabledEntry() throws Exception {
        ...
        try {
            ...
            assertEquals("Menu d�sactiv� : sous-menu2", e.getMessage());
        }
    }
    ...
    public void test_clickToDisplayAPopupMenuThatDoesNotAppear() throws Exception {
        ...
        try {
            ...
            assertEquals("Le menu contextuel associ� au composant 'PopupButton' est introuvable",
                         e.getMessage());
        }
    }
    ...
    protected void showFrame() {
        ...
        // Test avec une quote dans le libell� du sous-menu
