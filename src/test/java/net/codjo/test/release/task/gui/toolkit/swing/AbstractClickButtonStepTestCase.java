...
public abstract class AbstractClickButtonStepTestCase extends JFCTestCase {
    ...
    }// Attention : Bug jfcunit => si le menu contextuel d�passe visuellement de la frame,


    // jfcunit ne le voit pas, il faut alors augmenter la taille de la frame en cons�quence.
