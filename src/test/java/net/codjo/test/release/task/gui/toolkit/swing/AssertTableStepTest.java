...
public class AssertTableStepTest extends JFCTestCase {
    ...
    public void test_expectedRenderer() throws Exception {
        ...
        step.setMode(AUTO_MODE);
        step.setExpected("true");
        step.setExpectedCellRenderer(CustomRenderer.class.getName());
        step.proceed(context);
    }
    ...
    public void test_specificTestBehaviorOnTable() throws Exception {
        ...
        GuiToolkitManagerUtils.proceedAndAssert(step, this, logString, "MyTableMockTestBehavior.assertTable", myComponent);        
    }
    ...
    public void test_specificTestBehaviorOnRenderer() throws Exception {
        ...
        GuiToolkitManagerUtils.proceedAndAssert(step, this, logString, "MyTableCellRendererTestBehavior.assertTable", myComponent);
    }
