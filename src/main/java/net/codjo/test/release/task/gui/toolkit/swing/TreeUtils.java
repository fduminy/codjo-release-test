...
import net.codjo.test.release.task.gui.toolkit.swing.converter.TreeNodeModelConverter;
import net.codjo.test.release.task.gui.toolkit.swing.converter.TreeNodeRendererConverter;
/**
 * M�thodes utilitaires pour la gestion des {@link JTree}
 *
...
final class TreeUtils {
     ...
     *
     * @param tree l'arbre
     * @param path chemin du noeud, avec s�parateur ':'
     *
     * @return l'objet {@link TreePath} correspondant, ou <code>null</code> si le noeud n'est pas trouv�.
     *
     * @throws GuiFindException si le noeud n'a pas �t� trouv� et renvoie la liste des noeuds disponibles.
     */
    ...
    /**
     * Construction d'un treePath s�par� par des ':' et utilisant le renderer du JTree.
     *
     * @return le path
     */
